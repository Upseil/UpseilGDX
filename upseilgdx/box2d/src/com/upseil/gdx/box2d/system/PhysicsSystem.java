...
import com.upseil.gdx.box2d.action.FireEndContactEvent;
import com.upseil.gdx.box2d.action.FirePostSolveEvent;
import com.upseil.gdx.box2d.action.FirePreSolveEvent;
    ...
    protected void processSystem() {
        ...
        ArtemisCollections.forEachComponent(bodiedActors.getEntities(), bodyMapper, actorMapper,
            (body, actor) -> {
                ...
                Vector2 centerOfMass = body.getCenterOfMass(); // FIXME This doesn't work in general
